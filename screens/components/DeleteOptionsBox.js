  ...
  render(){
    ...
    return(
      <View
        ...
        <TouchableOpacity
          activeOpacity = {1}
          style = {{ alignItems: "center", flex: 1, flexDirection: "row",  paddingTop: 7, paddingBottom: 7, width: this.width}}
          onPress = {this.props.onPress}>

          <View
          style = {{justifyContent: 'center', width: this.width*(3/16), alignItems: 'center'}}>
          <HistoryCircle
          width = {this.width/16}
          ...
          <View
          style = {{justifyContent: 'center', width: this.width - this.width*(3/16)}}>
          <Text
