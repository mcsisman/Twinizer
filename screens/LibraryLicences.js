...
export default class LibraryLicencesScreen extends Component<{}>{
  ...
  renderLicenceBoxes(){
      ...
      for( let i = 0; i < licences.length; i++){
        ...
        borderTopWidth:1, borderBottomWidth:1, borderColor: global.isDarkMode ? global.darkModeColors[2] : 'rgba(128,128,128,0.3)',
        backgroundColor: global.isDarkMode ? "rgba(0,0,0,0.1)" : "rgba(255,255,255,1)", flexDirection: "row", flex:1, justifyContent: 'center'}}
          ...
          <View
          style={{justifyContent: 'center', width: this.width*7/8, height: this.width/8, bottom: 0, left: 0}}>
          <Text
            style = {{color: global.isDarkMode ? global.darkModeColors[3] : 'rgba(88,88,88,1)', fontSize: 15*this.width/360 }}>
            {this.licences[temp]}
          </Text>
          </View>
          <View
