    ...
    if (this.props.editPressed) {
        ...
        return (
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                opacity: this.props.messageDoneDisabled ? 0 : 1,
                justifyContent: 'center',
                alignItems: 'center',
                width: this.width / 4,
              }}
        ...
        return (
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                opacity: this.props.requestDoneDisabled ? 0 : 1,
                justifyContent: 'center',
                alignItems: 'center',
                width: this.width / 4,
              }}
      ...
      if (this.props.whichScreen == 'left') {
        return (
          <View
            style={{
              opacity: this.props.messageArray.length == 0 ? 0 : 1,
              borderBottomWidth: 1.5,
              borderColor: 'rgba(181,181,181,0.5)',
              height: this.width / 9,
              width: this.width,
        ...
        return (
          <View
            style={{
              opacity: this.props.requestArray.length == 0 ? 0 : 1,
              borderBottomWidth: 1.5,
              borderColor: 'rgba(181,181,181,0.5)',
              height: this.width / 9,
              width: this.width,
