 ...
 static defaultProps = {
  ...
  render(){
    ...
    return(
      ...
      activeOpacity = {1}
      style={{ flex: 1, flexDirection: "row",height: this.width/7, width: this.width + this.width*(3/16)}}
      ...
      <View
      style={{justifyContent: 'center', alignItems: "center", position: 'absolute', width: this.width/8, height: this.width/7, bottom: 0, right: 0}}>
