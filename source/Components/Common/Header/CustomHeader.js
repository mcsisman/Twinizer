  ...
  render() {
    ...
    if (this.props.whichScreen == 'Messages') {
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{
                  position: 'absolute',
                  width: Math.min(this.width / 6, (headerHeight * 4) / 5),
                  height: Math.min(this.width / 6, (headerHeight * 4) / 5),
                  justifyContent: 'center',
                  alignItems: 'center',
                  backgroundColor: global.isDarkMode
                    ? global.darkModeColors[1]
      ...
      if (this.props.whichScreen == 'Main') {
          ...
          <View
            ...
            <View
              style={{
                ...
                width: ((headerHeight * 9) / 10) * (196 / 211),
                height: (headerHeight * 9) / 10,
                justifyContent: 'center',
                alignItems: 'center',
                backgroundColor: global.isDarkMode
                  ? global.darkModeColors[1]
              ...
              <TouchableOpacity
                ...
                style={{
                  opacity: filterOpacity,
                  width:
                    Math.min(this.width / 6, (headerHeight * 4) / 5) *
                    (196 / 211),
                  height: Math.min(this.width / 6, (headerHeight * 4) / 5),
                  justifyContent: 'center',
                  alignItems: 'center',
                ...
                <Image
                  ...
                  source={{uri: 'filter' + global.themeForImages}}></Image>
              </TouchableOpacity>
            </View>
          </View>
        );
        ...
        if (
          this.props.whichScreen == 'Settings' ||
          this.props.whichScreen == 'History'
        ) {
          return (
            <View
              style={{
            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  top: (headerHeight - this.width * (1 / 10)) / 2,
                  justifyContent: 'center',
                  alignItems: 'center',
                  backgroundColor: global.isDarkMode
                    ? global.darkModeColors[1]
                ...
                <Image
                  ...
                  source={{uri: 'backarrow' + global.themeForImages}}></Image>
              </TouchableOpacity>
