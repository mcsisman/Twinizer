    ...
    if(global.keyboardHeight == null || global.keyboardHeight == undefined){
      ...
      if(!this.state.splashOver){
        ...
        return(
         ...
         this.setState({keyboardOpen: true})}}
          style={{ fontFamily: Platform.OS == "android" ? "" : "system font", paddingLeft: 0, paddingBottom:this.width/50, fontSize: 17*(this.width/360), width: this.width*(6/10),
        ...
        onPress={()=>this.check() }>
        <Text style={{fontFamily: Platform.OS == "android" ? "" : "system font", textAlign: 'center', color: 'white', fontSize: 17*(this.width/360)}}>
          {lang.Login}
        </Text>
        </TouchableOpacity>
        </View>
        ...
        <Text style={{
          fontFamily: Platform.OS == "android" ? "" : "system font",
          textAlign: 'right',
          color: 'white',
        ...
        <Text style={{fontFamily: Platform.OS == "android" ? "" : "system font", textAlign: 'left', color: 'white', fontSize: 18*(this.width/360)}}>
          {lang.ForgotPassword}
        </Text>
        </TouchableOpacity>
