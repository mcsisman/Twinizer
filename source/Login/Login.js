          ...
          <ImageBackground
            ...
            <View
              ...
              <View
                style={{
                  position: 'absolute',
                  width: '100%',
                  height: this.width * (5.8 / 10) + this.height * (0.1 / 10),
                  flexDirection: 'column',
                  flex: 1,
                  alignItems: 'center',
                }}>
                ...
                />
                <Image
                  source={{uri: 'twinizerlogin'}}
                  style={{
                    width: this.width * (0.8 / 10) * (782 / 159),
                    height: this.width * (0.8 / 10),
                  }}
                />
              </View>
            </View>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                style={{
                  position: 'absolute',
                  padding: this.width / 50,
                  bottom: this.width / 35,
