    ...
    if(global.keyboardHeight == null || global.keyboardHeight == undefined){
      ...
      if(!this.state.splashOver){
        ...
        return(
         ...
         this.setState({keyboardOpen: true})}}
          style={{ fontFamily: Platform.OS == "android" ? "" : "San Fransisco", paddingLeft: 0, paddingBottom:this.width/50, fontSize: 17*(this.width/360), width: this.width*(6/10),
        ...
        onPress={()=>this.check() }>
        <Text style={{fontFamily: Platform.OS == "android" ? "" : "San Fransisco", textAlign: 'center', color: 'white', fontSize: 17*(this.width/360)}}>
          {lang.Login}
        </Text>
        </TouchableOpacity>
        </View>
        ...
        <Text style={{
          fontFamily: Platform.OS == "android" ? "" : "San Fransisco",
          textAlign: 'right',
          color: 'white',
        ...
        <Text style={{fontFamily: Platform.OS == "android" ? "" : "San Fransisco", textAlign: 'left', color: 'white', fontSize: 18*(this.width/360)}}>
          {lang.ForgotPassword}
        </Text>
        </TouchableOpacity>
