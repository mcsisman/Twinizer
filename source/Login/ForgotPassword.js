  ...
  render(){
    ...
    return(
      ...
      <TextInput
        ...
        style={{color: global.isDarkMode ? global.darkModeColors[3]: 'rgba(0,0,0,0.4)', paddingBottom: 0, fontSize: 20*(this.width/360), position: 'absolute', width: this.width*(7/10), height: (this.height*8)/100, flex:1, bottom: (this.height*45)/100, right: this.width*(1.5/10),
