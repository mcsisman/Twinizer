...
export default class ImageUploadScreen extends React.Component {
  ...
  uploadPhoto = async (uri1, uri2, uri3, uri4) => {
    ...
    var ref1 = storageRef.child(
      'Photos/' + auth().currentUser.uid + this.state.str1,
    );
    await ref1
      .put(blob1)
      .then(async (snapshot) => {
        ...
        var ref2 = storageRef.child(
          'Photos/' + auth().currentUser.uid + this.state.str2,
        );
        await ref2
          .put(blob2)
          .then(async (snapshot) => {
            ...
            var ref3 = storageRef.child(
              'Photos/' + auth().currentUser.uid + this.state.str3,
            );
            await ref3
              .put(blob3)
              .then(async (snapshot) => {
                ...
                var ref4 = storageRef.child(
                  'Photos/' + auth().currentUser.uid + this.state.str4,
                );
                await ref4
                  .put(blob4)
                  .then(async (snapshot) => {
      ...
      <SafeAreaView
        ...
        <View
          ...
          <View
            ...
            <TextBox text={lang.PleaseUploadFourPhotos} />
          </View>
            ...
            <View
              ...
              <View
                ...
                <ImageUploader
                  ...
                  onPress={() =>
                    this.setState({isVisible1: true, selectedPhoto: 1})
                  }
              ...
              <View
                ...
                <ImageUploader
                  ...
                  onPress={() =>
                    this.setState({isVisible1: true, selectedPhoto: 2})
                  }
            ...
            <View
              ...
              <View
                ...
                <ImageUploader
                  ...
                  onPress={() =>
                    this.setState({isVisible1: true, selectedPhoto: 3})
                  }
              ...
              <View
                ...
                <ImageUploader
                  ...
                  onPress={() =>
                    this.setState({isVisible1: true, selectedPhoto: 4})
                  }
              ...
              <OvalButton
                ...
                onPress={() =>
                  this.uploadPhoto(
                    ...
                    this.state.profilePhoto3,
                    this.state.profilePhoto4,
                  )
                }
