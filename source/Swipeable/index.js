...
var Swipeable = function (_PureComponent) {
  ...
  function Swipeable() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Swipeable.__proto__ || Object.getPrototypeOf(Swipeable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if ( global.swipeCount != 0 && (leftActionActivated || global.leftD2A2) && canSwipeRight && x >= leftActionActivationDistance) {
        if(isSwipingRight && global.flag2){
          console.log("LA2")
          center = center + global.width*(5/10)
          deactivateLeft = true
          global.deactivationDistanceLeft = global.deactivationDistanceLeft + global.width*(5/10)
          global.activationDistanceLeft = global.activationDistanceLeft + global.width*(5/10)
      ...
      if ( global.swipeCount < global.emailArrayLength && (rightActionActivated || global.rightD2A2 ) && canSwipeLeft && x <= -rightActionActivationDistance) {
        if(isSwipingLeft && global.flag6){
          console.log("RA2")
          center = center - global.width*(5/10)
          global.activationDistanceRight = global.activationDistanceRight + global.width*(5/10)
          global.deactivationDistanceRight = global.deactivationDistanceRight + global.width*(5/10)
