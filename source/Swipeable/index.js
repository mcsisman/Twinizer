...
var center = 0;
var deactivateRight = false;
var deactivateLeft = false;
      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            ...
            (_ref =
              Swipeable.__proto__ ||
              Object.getPrototypeOf(Swipeable)).call.apply(
              _ref,
              [this].concat(args),
            ),
          )),
        ...
        (_this.recenter = function () {
          var animationFn =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : _this.props.swipeReleaseAnimationFn;
          var animationConfig =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : _this.props.swipeReleaseAnimationConfig;
        ...
        (_this._handlePan = _reactNative.Animated.event(
          [
            null,
            {
        ...
        (_this._handlePanResponderMove = function (event, gestureState) {
          var _this$props = _this.props,
            leftActionActivationDistance = global.activationDistanceLeft,
            leftActionDeactivationDistance = global.deactivationDistanceLeft,
            leftButtonsActivationDistance =
              _this$props.leftButtonsActivationDistance,
            ...
            rightActionActivationDistance = global.activationDistanceRight,
            rightActionDeactivationDistance = global.deactivationDistanceRight,
            rightButtonsActivationDistance =
              _this$props.rightButtonsActivationDistance,
          ...
          if (
            global.swipeCount != 0 &&
            (leftActionActivated || global.leftD2A2) &&
            canSwipeRight &&
            ...
            if (isSwipingRight && global.flag2) {
              ...
              global.deactivationDistanceLeft =
                global.deactivationDistanceLeft + global.width * (5 / 10);
              global.activationDistanceLeft =
                global.activationDistanceLeft + global.width * (5 / 10);
          ...
          if (
            (leftActionActivated || global.leftD2D1) &&
            (canSwipeRight || global.swipeCount == 1) &&
            x < leftActionDeactivationDistance
          ) {
            if (isSwipingLeft && global.flag3 && deactivateLeft) {
              console.log('LD1');
              center = center - global.width * (5 / 10);
              global.activationDistanceLeft =
                global.activationDistanceLeft - global.width * (5 / 10);
          ...
          if (
            leftActionActivated &&
            (canSwipeRight || global.swipeCount == 2) &&
            x < leftActionDeactivationDistance
          ) {
            if (isSwipingLeft && global.flag4 && deactivateLeft) {
              console.log('LD2');
              center = center - global.width * (5 / 10);
              global.activationDistanceLeft =
                global.activationDistanceLeft - global.width * (5 / 10);
          ...
          if (
            global.swipeCount < global.emailArrayLength &&
            (rightActionActivated || global.rightD2A2) &&
            canSwipeLeft &&
            ...
            if (isSwipingLeft && global.flag6) {
              ...
              global.activationDistanceRight =
                global.activationDistanceRight + global.width * (5 / 10);
              global.deactivationDistanceRight =
                global.deactivationDistanceRight + global.width * (5 / 10);
          ...
          if (
            (rightActionActivated || global.rightD2D1) &&
            canSwipeLeft &&
            x > -rightActionDeactivationDistance
          ) {
            if (isSwipingRight && global.flag7 && deactivateRight) {
              console.log('RD1');
              center = center + global.width * (5 / 10);
              global.activationDistanceRight =
                global.activationDistanceRight - global.width * (5 / 10);
          ...
          if (
            ...
            if (isSwipingRight && global.flag8 && deactivateRight) {
              console.log('RD2');
              center = center + global.width * (5 / 10);
              global.activationDistanceRight =
                global.activationDistanceRight - global.width * (5 / 10);
        ...
        (_this._handlePanResponderEnd = function (event, gestureState) {
          var _this$props2 = _this.props,
            ...
            onRightButtonsCloseRelease =
              _this$props2.onRightButtonsCloseRelease,
          ...
          animationFn(pan, animationConfig).start(function () {
            ...
            var _this$props3 = _this.props,
              ...
              onLeftButtonsCloseComplete =
                _this$props3.onLeftButtonsCloseComplete,
              ...
              onRightButtonsOpenComplete =
                _this$props3.onRightButtonsOpenComplete,
              onRightButtonsCloseComplete =
                _this$props3.onRightButtonsCloseComplete,
        ...
        (_this._panResponder = _reactNative.PanResponder.create({
          ...
          onMoveShouldSetPanResponderCapture:
            _this._handleMoveShouldSetPanResponder,
      ...
      value: function _getReleaseAnimationConfig() {
        var _props5 = this.props,
          leftActionReleaseAnimationConfig =
            _props5.leftActionReleaseAnimationConfig,
          leftButtons = _props5.leftButtons,
          leftButtonsOpenReleaseAnimationConfig =
            _props5.leftButtonsOpenReleaseAnimationConfig,
          leftButtonsCloseReleaseAnimationConfig =
            _props5.leftButtonsCloseReleaseAnimationConfig,
          ...
          rightButtonsOpenReleaseAnimationConfig =
            _props5.rightButtonsOpenReleaseAnimationConfig,
          rightButtonsCloseReleaseAnimationConfig =
            _props5.rightButtonsCloseReleaseAnimationConfig,
          rightButtonWidth = _props5.rightButtonWidth,
          swipeReleaseAnimationConfig = {
            toValue: {x: center, y: 0},
            duration: 250,
    ...
    },
    {
      ...
      value: function render() {
        var _props7 = this.props,
          ...
          style = _props7.style,
          props = _objectWithoutProperties(_props7, [
            'children',
        ...
        return _react2.default.createElement(
          _reactNative.View,
          _extends(
            {onLayout: this._handleLayout, style: [styles.container, style]},
          ...
          canSwipeRight &&
            _react2.default.createElement(
              ...
              {
                style: [
                  {transform: transform, marginLeft: -width, width: width},
                  leftContainerStyle,
                ],
              },
          ...
          canSwipeLeft &&
            _react2.default.createElement(
              ...
              {
                style: [
                  {transform: transform, marginRight: -width, width: width},
                  rightContainerStyle,
                ],
              },
